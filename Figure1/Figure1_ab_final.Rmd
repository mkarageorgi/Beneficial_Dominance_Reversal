...
Here, I first create a map of pesticide use per area of cropland for all available countries for the period 2000--2021.
...
This code reshapes and processes a dataset containing allele frequencies for the I161V mutation in the Ace gene across different Drosophila populations worldwide. It joins this genetic data with sample metadata (including geographic locations) and filters samples collected between 2000-2021
