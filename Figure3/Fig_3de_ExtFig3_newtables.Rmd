...
tab_model(model_LD50_cage.E,
          ...
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 8. Effect of time on malathion resistance (LD50) in untreated cages from linear mixed-effects model analysis, related to Fig. 3e.")
```
...
tab_model(model_during_LD50.P,model_after_LD50.P,
          pred.labels = c("Intercept", "Time"),  # predictor labels 
          ...
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 6. Effect of time on malathion resistance (LD50) in treated cages from linear mixed-effects model analysis, related to Fig. 3d.")
```
