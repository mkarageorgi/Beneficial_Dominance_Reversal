...
-   The haf files for the Orchard 2021 can be found in the Google Drive in this link: <https://drive.google.com/drive/u/0/folders/1uAzkkZb-G8M5tUZdQI081lPTm2anhKn2>
...
library(sjPlot) # for table preparation
```
...
tab_model(model_during_treated_IGFG, model_after_treated_IGFG,
          pred.labels = c("Intercept", "Time"),  # predictor labels 
          dv.labels = c("During treatment", "After treatment"),
          string.p = "p-value",
          show.stat = TRUE,
          show.ci = FALSE, 
          show.se = TRUE,
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 5.1 Effect of time on S (IGFG) frequency in treated cages from linear mixed-effects model analysis, related to Fig. 3b")
```
...
tab_model(model_during_treated_VGFG, model_after_treated_VGFG,
          pred.labels = c("Intercept", "Time"),  # predictor labels 
          dv.labels = c("During treatment", "After treatment"),
          string.p = "p-value",
          show.stat = TRUE,
          ...
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 5.2 Effect of time on R1 (VGFG) frequency in treated cages from linear mixed-effects model analysis, related to Fig. 3b")
```
...
tab_model(model_during_treated_VGFA, model_after_treated_VGFA,
          pred.labels = c("Intercept", "Time"),  # predictor labels 
          dv.labels = c("During treatment", "After treatment"),
          string.p = "p-value",
          show.stat = TRUE,
          ...
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 5.3 Effect of time on R2 (VGFA) frequency in treated cages from linear mixed-effects model analysis, related to Fig. 3b")
```
...
tab_model(model_during_treated_VAYG, model_after_treated_VAYG,
          pred.labels = c("Intercept", "Time"),  # predictor labels 
          dv.labels = c("During treatment", "After treatment"),
          string.p = "p-value",
          show.stat = TRUE,
          ...
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 5.4 Effect of time on R3 (VAYG) frequency in treated cages from linear mixed-effects model analysis, related to Fig. 3b")
```
...
tab_model(model_control_IGFG,
          pred.labels = c("Intercept", "Time"),  # predictor labels 
          dv.labels = c("Beginning of treatment to end of experiment"),
          string.p = "p-value",
          show.stat = TRUE,
          show.ci = FALSE, 
          show.se = TRUE,
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 7.1 Effect of time on S (IGFG) frequency in control cages from linear mixed-effects model analysis, related to Fig. 3c")
...
tab_model(model_control_VGFG,
          ...
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 7.2 Effect of time on R1 (VGFG) frequency in control cages from linear mixed-effects model analysis, related to Fig. 3c")
...
tab_model(model_control_VGFA,
          ...
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 7.3 Effect of time on R2 (VGFA) frequency in control cages from linear mixed-effects model analysis, related to Fig. 3c")
...
tab_model(model_control_VAYG,
          ...
          p.style = "scientific",
          digits.p = 2,
          title = "Supplementary Table 7.4 Effect of time on R3 (VAYG) frequency in control cages from linear mixed-effects model analysis, related to Fig. 3c")
```
...
Vignette for preparing regression tables <https://strengejacke.github.io/sjPlot/articles/tab_model_estimates.html#show-or-hide-further-columns>
