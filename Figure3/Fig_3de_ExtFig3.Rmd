...
StatTable(model = model_LD50_cage.E, 
          directory = "./tables/", 
          display_title = "Extended Data Table 5.2 Effect of time on malathion resistance (LD50) in untreated cages",  # Title for the table
...
StatTable(c(model_during_LD50.P, model_after_LD50.P), 
          display_title = 'Extended Data Table 5.1 Effect of time on malathion resistance (LD50) in treated cages',
